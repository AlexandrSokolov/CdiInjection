...
public class CoderInjectorTest
{
    @Deployment
    public static WebArchive createDeployment() throws URISyntaxException
    {
        ...
        WebArchive war = ShrinkWrap.create(WebArchive.class, "cdiinjection.war")
                .addClasses(Coder.class, CoderImpl.class, CoderInjector.class)
    ...
    @Inject
    CoderInjector coderInjector;

    @Test
    public void testWhatToDo()
    {
        Assert.assertNotNull(coderInjector);
        Assert.assertEquals(CoderImpl.CODER_IMPL, coderInjector.whatToDo());
    }
}
